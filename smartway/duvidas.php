<?php
  ...
  if (isset($_POST['deletar'])) {
    ...
    $sql        =   mysqli_query($link, "DELETE FROM smartway.contato WHERE c_email='$f_email'");
    $u_email    =   mysqli_real_escape_string($link, $_POST['f_email']);
    $sql        =   mysqli_query($link, "DELETE FROM smartway.usuario WHERE c_email='$u_email'");
    ...
    <form method="POST">
      <table class="table table-bordered table-responsive-md table-striped text-center">
            ...
            <div class="form-group has-search">
              <input type="text" name="f_email" class="form-control" placeholder="Delete uma duvida localizando pelo E-mail">
            </div>
            </div>

              <?php
                include_once("duvidass.php");
              ?>    
            </tbody>
      </table>
    </div>
